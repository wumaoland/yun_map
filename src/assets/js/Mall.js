...
export default class {
    ...
    createFloor(floorId) {
        ...
        if (this.is3d) {
            ...
            this.texture = textureLoader.load(floor.map);
            var img = new Image();
            ...
            //创建几何体网格模型
            let mesh = new THREE.Mesh(new THREE.BoxGeometry(img.width * 1.74, img.height * 1.74, 10), material);
    ...
    createNameSprites(shop, center) {
        ...
        if (shop.icon !== '') {
            ...
            //新增摊位ID
            moonDiv.setAttribute("fid", shop.fid);
        } else {
            moonDiv = document.createElement('img');
            moonDiv.className = 'label hidden';
            moonDiv.setAttribute("src", 'data:image/png;base64,');
            //新增摊位ID
            moonDiv.setAttribute("fid", shop.fid);
